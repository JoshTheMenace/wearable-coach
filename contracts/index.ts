...
export type Frame = { frameId: string; receivedAt: number; capturedAt?: number; clockUncertaintyMs?: number; cameraSource: string; freshness: 'fresh'|'stale'|'unknown'; captureTimeBasis: string; workId?: string; width?: number; height?: number };

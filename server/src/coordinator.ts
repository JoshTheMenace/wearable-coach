...
// Normalize speech repetitions for intent checks; retain the original transcript and negations.
const spokenIntent = (text:string) => text.replace(/\b([\w’']+(?:\s+[\w’']+)?)(?:\s+\1\b)+/gi,'$1');
const practiceFinished = (text:string) => {

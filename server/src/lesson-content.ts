...
export function lessonPresentation(lesson:LessonState):LessonPresentation {
  ...
  if(lesson.activeClip)return presentation({id:lesson.activeClip==='overview'?'cpr-overview':'cpr-hand-replay',template:'show',chapter:lesson.activeClip==='overview'?'WATCH · DEMONSTRATION':'HAND PLACEMENT · 5-SECOND REPLAY',title:lesson.activeClip==='overview'?'Watch the hand contact point':'Review the contact point',body:'Preparing your video…',hint:'Tap Next on your phone'},'I’ll pull that up.',['hand_location','recoil']);
